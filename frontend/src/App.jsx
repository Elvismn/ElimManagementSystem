...
const Students = () => <div className="p-6 bg-white rounded-lg shadow">Students Page (Coming Soon)</div>
const Parents = () => <div className="p-6 bg-white rounded-lg shadow">Parents Page (Coming Soon)</div>
...
const Settings = () => <div className="p-6 bg-white rounded-lg shadow">Settings Page (Coming Soon)</div>
